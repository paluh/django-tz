...
django-tz treats timezones transitions in similar manner like django treats languages localization. Timezone is stored in global cache and datetime values can be ,,localized'' according to it in templates with custom template filter or in forms with custom form fields.
